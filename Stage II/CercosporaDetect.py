...
# - the trained model for cercospora leaf spot detection;
...
MODEL_PATH = "Cercospora_Model.pt"
INPUT_IMAGES_DIR = "Crops"
OUTPUT_IMAGES_DIR = "CercosporaImages"
OUTPUT_LABELS_DIR = "CercosporaLabels"
